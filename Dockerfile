...
FROM python:3.13.0a4-alpine3.19 AS dockerpi-vm
LABEL maintainer="Livin Nector <livinnector2001@gmail.com>"
...
COPY --from=qemu-builder /qemu/socat /usr/local/bin/socat
...
RUN python3 -m pip install pexpect qemu-rpi-gpio
